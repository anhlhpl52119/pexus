...
Use `references/migrate-to-v7.md` documentation for details. This skill is the working checklist; read the guide for exact examples or when behavior is unclear.
